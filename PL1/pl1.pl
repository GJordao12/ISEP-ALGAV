...
% a
potencia(_,0,1):-!.
potencia(N,P,R):-P1 is P-1,potencia(N,P1,R1),R is R1*N.
...
% d
% div(Numerador,Divisor,Quociente,Resto)
% 15/3 => 15-3 -> 12-3 -> 9-3 -> 6-3 -> 3-3 -> Q = 5 ^ R=0
div(N,D,0,R):- N<D,R is N,!.
div(N,D,Q,R):-Ndivd is N-D,div(Ndivd,D,Q1,R),Q is Q1+1.
